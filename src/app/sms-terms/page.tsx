  ...
  return (
    <PolicyLayout title="SMS Terms & Conditions" effectiveDate="August 15, 2026">
      ...
      <P>
        ...
        invites you to press 1 if you would like to continue the conversation
        by text, and discloses the message frequency, that message and data
        rates may apply, and how to opt out. If you press 1, we send a text to
        the number you called from. If you do not press 1, no text is sent. If
        you press 1 and do not reply to our text, we may send up to two brief
        follow-up messages about your inquiry before the conversation closes.
      ...
      <P>
        ...
        per inquiry, and no messages at all unless you called us and requested
        a text by pressing 1.
      </P>
