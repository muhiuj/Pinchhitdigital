...
// build. The URL never changes; src/lib/webinars.ts is the monthly edit
// point. Registration feeds n8n via /api/webinar-register; replays are
...
const eventSchema = {
  ...
  "@type": "Event",
  name: `Build It Live: ${NEXT_SESSION.title}`,
  description: HERO.subhead,
  startDate: NEXT_SESSION.startIso,
  endDate: NEXT_SESSION.endIso,
...
export default function BuildItLivePage() {
  return (
